...
SYSTEM_PROMPT = (
    ...
    "       group_name: an optional group/section the item belongs to, if the\n"
    "         user names one — 'add milk to groceries' => 'Groceries';\n"
    "         'under my Overwatch project' => 'Overwatch'. Title-case it. Strip\n"
    "         the group words from the task text ('Buy milk', not 'Buy milk to\n"
    "         groceries'). If no group is mentioned, use \"\" (empty).\n"
    ...
    "\n"
    "User: \"add milk and eggs to my groceries\"\n"
    "Output: {\"intent\": \"add_commitment\", \"items\": [{\"text\": \"Milk\", \"group_name\": \"Groceries\"}, {\"text\": \"Eggs\", \"group_name\": \"Groceries\"}], \"reply\": \"Added milk and eggs to Groceries.\"}\n"
    "\n"
